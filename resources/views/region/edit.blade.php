...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Region edit</h4>
                    ...
                    <form method="POST" action="{{ route('regions.update', $region) }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter region name" value="{{$region->name}}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar" placeholder="Enter region name AR" value="{{$region->name_ar}}">
